...
char ssid[] = "xxx"; // Place your wifi SSID here
char password[] =  "xxx"; // Place your wifi password here
char token[] = "xxx"; // Place your token, find it in 'account' at Circus. It will identify you.
